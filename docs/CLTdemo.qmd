...
This Quarto document demonstrates a document that is rendered to html in the `./docs` subdirectory, whereupon it becomes visible as a static webpage in `github.io`. To achieve this:
