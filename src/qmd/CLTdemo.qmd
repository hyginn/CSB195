...
1. Github recognizes that a `./docs/` directory exists, finds the `.html` files it contains, and makes them accessible under the URL `https://myAccount.github.io/myRepository/my/subdirectory/CLTdemo.html`.
...
#       and hist() would choke on that. My, my.
