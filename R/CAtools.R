...
printRule <- function(R, quietly = FALSE) {
  #' @title printRule()
  ...
  #'                 side-effect.
  #'
  #' @details printRule() prints out the construction of a cellular automaton
...
................................."
  ...
  v <- printRule(R, quietly = TRUE)  # convert integer to binary array
